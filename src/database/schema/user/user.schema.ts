...
import { Address, AddressSchema } from '../common/address.schema.ts';
...
@Schema({
  ...
  // },
  // statics: {
  //   async findByEmailAndPassword(this: any, email: string, password: string) {
